...
<head>
    ...
    <title>Laporan Pelanggaran | E-Counseling</title>
            ...
            <main>
                <div class="container-fluid px-4 pt-4">
                    <div class="page-header">
                        <h1><i class="fas fa-plus-circle me-2" style="color:#bd5d38;"></i>Laporan Pelanggaran</h1>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('walikelas.laporan.store') }}" method="POST">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="{{ route('walikelas.laporan') }}" class="btn btn-cancel">
