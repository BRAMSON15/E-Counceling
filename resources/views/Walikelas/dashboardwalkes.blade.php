...
<html lang="id">
    <head>
        ...
        <title>Dashboard Walikelas | E-Counseling SMA NEGERI 12 AMBON</title>
        <!-- Google Fonts -->
        ...
        <style>
            ...
            .btn-lapor {
                background: #bd5d38; border: none; color: #fff;
                padding: 0.5rem 1.2rem; border-radius: 6px;
                font-weight: 700; font-size: 0.9rem; transition: all 0.25s;
            }
            .btn-lapor:hover { background: #a44d2d; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(189,93,56,0.4); color: #fff; }
            .btn-lapor i { margin-right: 0.4rem; }
                    ...
                    <div class="container-fluid px-4 pt-4">
                        ...
                        <div class="welcome-banner">
                            ...
                            <div class="welcome-badge d-none d-md-block">
                                <i class="fas fa-chalkboard-teacher me-1"></i> Walikelas
                            </div>
                        </div>

                        <!-- Page Header -->
                        <div class="page-header">
                            <h1><i class="fas fa-tachometer-alt me-2" style="color:#bd5d38;font-size:1.8rem;"></i>Dashboard Walikelas</h1>
                        </div>
