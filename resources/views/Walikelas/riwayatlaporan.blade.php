...
<html lang="id">
    <head>
        ...
        <title>Riwayat Laporan | E-Counseling SMA NEGERI 12 AMBON</title>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="{{ route('walikelas.riwayat') }}">
                ...
                <main>
                    <div class="container-fluid px-4 pt-4">
                        ...
                        <div class="page-header">
                            <h1><i class="fas fa-history me-2" style="color:#bd5d38;font-size:1.8rem;"></i>Riwayat Laporan</h1>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card content-card">
                                    <div class="card-header">
                                        <i class="fas fa-list-alt"></i> Riwayat Laporan Pelanggaran
                                    </div>
                                    <div class="card-body">
