...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{asset('berandautama/assets/img/logo1.png')}}" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="{{asset('berandautama/assets/img/logo1.png')}}" alt="..." /></span>
            </a>
