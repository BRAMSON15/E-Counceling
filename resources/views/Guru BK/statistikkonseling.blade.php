...
<html lang="id">
    <head>
        ...
        <title>Statistik Konseling | E-Counseling SMA NEGERI 12 AMBON</title>
        ...
        <style>
            ...
            .stat-card { border: none; border-radius: 0.9rem; overflow: hidden; box-shadow: 0 6px 20px rgba(0,0,0,0.12); transition: transform 0.25s ease, box-shadow 0.25s ease; }
            ...
            .stat-card .stat-info .stat-title { font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06rem; opacity: 0.85; }
            .stat-card .stat-info .stat-value { font-family: 'Saira Extra Condensed', sans-serif; font-size: 2.4rem; font-weight: 700; line-height: 1.1; }
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="{{ route('guru_bk.statistik') }}">
                ...
                <main>
                    <div class="container-fluid px-4 pt-4">
                        ...
                        <div class="page-header">
                            <h1><i class="fas fa-chart-bar me-2" style="color:#bd5d38;font-size:1.8rem;"></i>Statistik Konseling</h1>
                        </div>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="{{ route('guru_bk.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Statistik Konseling</li>
                        </ol>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card stat-card stat-brown">
                                    <div class="card-body">
                                        <div class="stat-info">
                                            <div class="stat-title">Siswa Dikonseling</div>
                        ...
                        <!-- STATISTIK CHART PLACEHOLDER -->
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card content-card">
                                    <div class="card-header">
                                        <i class="fas fa-chart-line"></i> Grafik Statistik Konseling
                                    </div>
                                    <div class="card-body" style="height: 300px; display: flex; align-items: center; justify-content: center; color: #999;">
