...
<html lang="id">
    <head>
        ...
        <title>Hasil Konseling | E-Counseling SMA NEGERI 12 AMBON</title>
                ...
                <main>
                    <div class="container-fluid px-4 pt-4">
                        ...
                        <div class="page-header">
                            <h1><i class="fas fa-handshake me-2" style="color:#bd5d38;font-size:1.8rem;"></i>Hasil Konseling</h1>
                        </div>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="{{ route('guru_bk.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Hasil Konseling</li>
                        </ol>

                        <!-- HASIL KONSELING TABLE -->
                        <div class="row mb-4">
                            <div class="col-12">
