...
<head>
    ...
    <meta name="description" content="Tambah User - E-Counseling SMA NEGERI 12 AMBON" />
    <title>Tambah User | E-Counseling</title>
            ...
            <main>
                <div class="container-fluid px-4 pt-4">
                    <div class="page-header">
                        <h1><i class="fas fa-user-plus me-2" style="color:#bd5d38;font-size:1.8rem;"></i>Tambah Pengguna</h1>
                    </div>
