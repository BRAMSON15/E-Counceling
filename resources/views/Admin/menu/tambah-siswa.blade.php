...
<head>
    ...
    <meta name="description" content="Tambah Siswa - E-Counseling SMA NEGERI 12 AMBON" />
            ...
            <main>
                <div class="container-fluid px-4 pt-4">
                    <div class="page-header">
                        <h1><i class="fas fa-user-plus me-2" style="color:#bd5d38;font-size:1.8rem;"></i>Tambah Siswa</h1>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tambahsiswa') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('kelas') is-invalid @enderror" id="kelas" name="kelas" value="{{ old('kelas') }}" placeholder="Contoh: X A, XI B" required>
                                            @error('kelas')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
